...
class ProductIndexer
{
     ...
     */
    private $productCollectionResource;
    ...
    public function __construct(
        ...
        $this->productCollectionResource = $productCollectionResource;
    }
    ...
    public function reindexRows(array $ids): void
    {
        ...
        $collection = $this->collectionFactory->create()->addFieldToFilter('rule_id', ['in' => $ids]);
