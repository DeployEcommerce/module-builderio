...
class ProductCollectionActions extends Column
{
    private const URL_PATH_EDIT = 'builderio/products/edit';
    private const URL_PATH_DELETE = 'builderio/products/delete';
